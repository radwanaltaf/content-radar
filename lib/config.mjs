...
const DEFAULTS = {
  ...
  vocabulary: {
    ...
    spelling: null,
    /**
     * Words exempt from the spelling check because they are identifiers rather
     * than prose. Case sensitive. Every real project needs some of these:
     * schema.org has Organization, CSS has color and center, React has
     * Fragment. Without an escape hatch the spelling rule gets switched off
     * entirely, which is a worse outcome than a short list.
     */
    spellingExceptions: [],
